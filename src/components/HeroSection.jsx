    ...
    return (
        <div className='flex flex-col items-center mt-6 lg:mt-20'>
            <h1 className='text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide'>
                VirturalR build tools
                <span className='bg-gradient-to-r from-orange-500 to bg-red-800 text-transparent bg-clip-text'>{" "}for developer</span>
            </h1>
            ...
            <div className='flex justify-center my-10'>
                ...
                <a href="#" className='py-3 px-4 mx-3 rounded-md border'>Documentaion</a>
            </div>
